...
public class CopyOfCERP005_AnswerII
{
	...
	private final static String text_comment = "Nadawanie uprawnieinnego do edycj";
	...
	public void TestMethod() throws Exception
	{
		try
		{
			...
			for (int i = 0; i < 20; i++)
			{
			questionPage.addQuestion(title_text, answer_contents_text);
			questionPage.addAnswer1(answer_contents_text);
			questionPage.addComment1(text_comment);
			}
